<div id="modale-contact">
    ...
    <div class="contenu-modale">
        <img class="image-contact" src="<?php echo get_stylesheet_directory_uri() . '/template_part/contact-header.png' ?>" alt="Le mot contact apparaît plusieurs fois afin de former la bannière du formulaire"/>
